...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        min4(list);
        System.out.println(" *** ");
        printOnbesBuyukEnKucuk(list);
        System.out.println(" *** ");
        printCiftElKareKucuktenBuyuge(list);
        System.out.println("\n *** \nprintCiftElKareKucuktenBuyuge");
        printTekElKareKucuktenBuyuge(list);
    ...
    public static void min3(List<Integer> list) {
        ...
        System.out.println(min);		//Optional[65]
    }
...
public static void printOnbesBuyukEnKucuk(List<Integer> list) {
	//list.stream().filter(t->t%2==1).filter(t->t>15).reduce(Integer::min);
	System.out.println(list.						//yazdir
			stream().
			filter(t->t%2==1 & t>15).		//tek ve 15'ten buyuk sarti
			reduce(Integer::min));		// en kucuk sayiyi ver 
}
public static void printCiftElKareKucuktenBuyuge(List<Integer> list) {
	
	list.
	stream().
	filter(Lambda01::ciftBul).
	map(t->t*t).sorted().forEach(Lambda01::printEl);		//144 484 1156 1764 3600
}
public static void printTekElKareKucuktenBuyuge(List<Integer> list) {
